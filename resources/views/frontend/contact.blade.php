...
@section('content')
                    ...
                    <div class="col">
                        <div class="feature-box feature-box-style-2">
                            ...
                            <div class="feature-box-info">
                                ...
                                <p class="text-4">
                                    <a href="mailto:pskturancetin@gmail.com" class="text-decoration-none">{{ config('settings.email1') }}</a><br>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5704.748385547648!2d29.936716337972623!3d40.76235141464086!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cb457dbfb026fb%3A0x68b5f383b1a7d979!2sAsosyal%20Ajans!5e0!3m2!1str!2str!4v1698358708609!5m2!1str!2str" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>@endsection
